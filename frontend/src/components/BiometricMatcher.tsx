...
export default function BiometricMatcher({ result, onUpdateBiometrics }: Props) {
  ...
  return (
    <div className="bg-white rounded-xl p-3 sm:p-4 shadow-xs border border-slate-200">
          ...
          {!cameraActive ? (
            <>
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg bg-[#0A2540] hover:bg-[#081e35] text-white shadow-xs transition cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 transition cursor-pointer"
            ...
            <button
              onClick={stopCamera}
              className="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded bg-rose-50 text-rose-800 border border-rose-200 cursor-pointer"
            >
      ...
      {faceWarning && (
        <div className="mb-3 p-2.5 rounded-lg bg-amber-50 border border-amber-300 text-amber-900 text-xs flex items-start gap-2">
      ...
      {cameraActive && (
        <div className="mb-3 p-3 rounded-xl bg-slate-900 border-2 border-[#0A2540] relative flex flex-col items-center">
          ...
          <div className="flex items-center gap-3 mt-3">
            <button
              ...
              className="px-5 py-2 rounded-lg bg-[#047857] hover:bg-[#065f46] text-white text-xs font-bold shadow-sm flex items-center gap-2 cursor-pointer"
            >
              <Camera className="w-4 h-4" />
              <span>Snap & Verify Biometrics</span>
            </button>
            <button
              onClick={() => {
      ...
      {isComparing && (
        <div className="mb-3 p-2.5 rounded-lg bg-blue-50 border border-blue-200 text-blue-900 text-xs flex items-center gap-2 animate-pulse font-medium">
          <RefreshCw className="w-4 h-4 animate-spin shrink-0 text-blue-700" />
          <span>Cross-matching passenger live biometric frame against official document portrait...</span>
        </div>
      )}
      ...
      {observations.length > 0 && (
        <div className="mt-2.5 p-2.5 rounded-lg bg-blue-50/70 border border-blue-200 text-[11px] text-slate-700 space-y-1">
