...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 antialiased">
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-6 py-4 space-y-4 pb-28">
        {/* Official MHA Security Classification Banner */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-3.5 py-2 rounded-xl bg-white border border-slate-200 text-xs shadow-xs">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-blue-50 text-blue-900 border border-blue-200 font-extrabold text-[10px] uppercase tracking-wider">
              RESTRICTED
            </span>
            <span className="font-semibold text-slate-700">
              MHA Border Security Operations Console • Authorized Immigration Screening Terminal
            </span>
          </div>
          <div className="flex items-center gap-2 self-end sm:self-auto">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 transition cursor-pointer"
